...
contract ERC20Interface {
    ...
    function allowance(address tokenOwner, address spender) public payable  returns (uint remaining);
...
contract CodeWithpriya is ERC20Interface, SafeMath {
    string public name;
